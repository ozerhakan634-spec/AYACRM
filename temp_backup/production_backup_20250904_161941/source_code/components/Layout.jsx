...
const Layout = ({ children, currentUser, onLogout, onUserUpdate }) => {
  ...
  const navigation = [
    ...
    { name: 'Finans', href: '/dashboard/finance', icon: FileText },
    { name: 'Destek', href: '/dashboard/support', icon: FileText },
            ...
            <div className="hidden lg:flex items-center space-x-4">
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-gray-700">{userData?.name || 'Kullanıcı'}</span>
                </button>
              </div>
            </div>
          </div>
