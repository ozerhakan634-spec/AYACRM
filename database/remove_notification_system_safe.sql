-- Güvenli Bildirim Sistemi Kaldırma Script'i
-- Bu script sadece bildirim sistemini kaldırır, diğer tabloların RLS politikalarına dokunmaz
...
WHERE trigger_name LIKE '%notification%' OR trigger_name LIKE '%create_notification%';
...
-- RLS politikalarını kaldır (sadece notifications tablosu için)
...
SELECT 'Bildirim sistemi güvenli şekilde kaldirildi!' as result;
